...
------------------------------------------------------------------------------
*/
const AnswerNo = ({ groupProps, thisMatcapMaterial }) => {
  /*
  ...
  */
  const { scale } = useSpring({
    loop: { reverse: true },
    from: { scale: [0.7, 0.7, 0.7] },
    to: { scale: [0.9, 0.9, 0.9] },
  ...
  */
  const onClick = e => {
    ...
    */
    setTimeout(() => {
      canvasState.currentContainer = 'answerNoContainer';
  ...
  */
  return (
    ...
    >
      ...
      {/*-----Main Text: I have...----------------------------------*/}
      <a.group
        name="GroupForPlatoAristotlesAnswerText"
        scale={scale}
        position={[0, 0, 0]}
        onClick={onClick}
      >
...
//   const bounce = () => {
//     api.start({
//       scale: [pouse ? 0.7 : 0.95, pouse ? 0.7 : 0.95, pouse ? 0.7 : 0.95],
//     });
//     pouse = !pouse;
