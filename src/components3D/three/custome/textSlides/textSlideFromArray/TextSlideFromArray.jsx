...
const TextSlideFromArray = ({
  ...
  */
        ...
        <group {...groupProps}>
          {textLinesPl.map((line, index) => (
            <TextVerse
              ...
              */
              letterSpacing={
                (letterSpacingPl && letterSpacingPl[index]) || 0.15
              }
            ...
            <TextVerse
              ...
              fontResponsiveness={
                windowSize.width < 300
                  ...
                  : windowSize.width < 600
                  ? fontSizeEn[index].fontMedium
                  : fontSizeEn[index].fontLarge
              }
              letterSpacing={
                (letterSpacingEn && letterSpacingEn[index]) || 0.15
              }
              ...
              strokeWidth={strokeWidthEn && strokeWidthEn[index]}
            />
          ))}
        </group>
      </A11y>
  ...
  JSX
  */
  return canvasGlobalState.languageVersion === 1 ? languagePl() : languageEn();
};
