...
const PseudoFlagMaterial = shaderMaterial(
  ...
  */
  ...
  /*
  what "vWave" does?
  it's required in FS; it allowes image to match vertex more preciselly; without it imaga can look as if it were positioned "next to" vertices; additionally, using "special" factor we can increase image's waving amplitude
  */
  varying float vWave;

  void main(){

    float waveImpulse = vWave * 0.2;
