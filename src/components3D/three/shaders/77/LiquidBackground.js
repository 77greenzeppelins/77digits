...
const LiquidBackgroundShaderMaterial = shaderMaterial(
  /*
  ----------Uniforms Section---------------------------------------
  */
  {
  ...
  void main (){
      ...
      */
      ...
      for(float i = 1.0; i < 6.0; i++){
          vUv.x += i * 0.05  * sin(vUv.y * i * i  + tAnimator * 0.05) * cos(vUv.x * i * i  + tAnimator * 0.3);
      }
      /*
      Final Color !!!
      */
      gl_FragColor = vec4(vec3(vUv.x + 0.7), 1.);
  }
  `
);

export { LiquidBackgroundShaderMaterial };
